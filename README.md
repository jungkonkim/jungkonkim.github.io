...
```shell
$ git clone -b develop https://github.com/jungkonkim/jungkonkim.github.io.git [SITE_DIRECTORY]
$ npm install
```
...
```javascript
module.exports = {
  title: `KONPAGE`, // 사이트의 제목
  author: 'Jungkon Kim', // 사이트의 소유자
  description: "Jungkon Kim's blog", // 사이트의 설명
  siteUrl: 'https://jungkonkim.github.io', // 사이트의 주소
  ...
  disqusShortname: 'kon-blog', // 댓글 기능을 위한 Disqus의 shortname, 비활성화: ''
};
```
